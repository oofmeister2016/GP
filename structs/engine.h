...
public:
	...
	bool Transmit(bool onlyReliable)
	{
		...
		return CallVFunction<fn>(this, 49)(this, onlyReliable);
	}
...
public:
	...
	int GetPlayerForUserID(int userID)
	{
		...
		return CallVFunction< OriginalFn >(this, 9)(this, userID);
	}

	void CEngine::GetScreenSize(int& width, int& height)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, int&, int&);
		CallVFunction< OriginalFn >(this, 5)(this, width, height);
	}

	INetChannelInfo* GetNetChannelInfo(void)
	{
		typedef INetChannelInfo*(__thiscall* OriginalFn)(PVOID);
		return CallVFunction< OriginalFn >(this, 78)(this);
	}

	bool CEngine::GetPlayerInfo(int iIndex, player_info_t* pInfo)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID, int, player_info_t*);
		return CallVFunction< OriginalFn >(this, 8)(this, iIndex, pInfo);
	}
	...
	int CEngine::GetLocalPlayer(VOID)
	{
		typedef int(__thiscall* OriginalFn)(PVOID);
		return CallVFunction< OriginalFn >(this, 12)(this);
	}

	matrix3x4& CEngine::WorldToScreenMatrix(void)
	{
		typedef matrix3x4& (__thiscall* OriginalFn)(PVOID);
		return CallVFunction< OriginalFn >(this, 37)(this);
	}

	void CEngine::ExecuteClientCmd(char const* szCommand)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, char const* szCommand);
		CallVFunction< OriginalFn >(this, 105)(this, szCommand);
	}

	void CEngine::GetViewAngles(Vector& vAngles)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, Vector&);
		return CallVFunction< OriginalFn >(this, 18)(this, vAngles);
	}

	void CEngine::SetViewAngles(Vector& vAngles)
	{
		typedef void(__thiscall* oSetViewAngles)(PVOID, Vector&);
		return CallVFunction< oSetViewAngles >(this, 19)(this, vAngles);
	}

	bool CEngine::IsConnected()
	{
		typedef bool(__thiscall* oGetScreenSize)(PVOID);
		return CallVFunction< oGetScreenSize >(this, 27)(this);
	}

	bool CEngine::IsInGame()
	{
		typedef bool(__thiscall* oLocal)(PVOID);
		return CallVFunction< oLocal >(this, 26)(this);
	}

	int CEngine::GetMaxClients()
	{
		typedef bool(__thiscall* oGetMaxClients)(PVOID);
		return CallVFunction< oGetMaxClients >(this, 20)(this);
	}

	float CEngine::Time()
	{
		typedef float(__thiscall* oTime)(PVOID);
		return CallVFunction< oTime >(this, 14)(this);
	}
