...
public:
	...
	float GetSpread()
	{
		if (this != nullptr)
		{
			...
			GetSpreadFn Spread = (GetSpreadFn)((*(PDWORD_PTR*)this)[437]);//460
			return Spread(this);
		}
	}
	float GetCone()
	...
	float GetInaccuracy()
	{
		...
		return CallVFunction<Fn>(this, 468)(this); //469
	}
	...
	void UpdateAccuracyPenalty()
	{
		...
		UpdateAccuracyPenaltyFn Update = (UpdateAccuracyPenaltyFn)((*(PDWORD_PTR*)this)[469]);
		return Update(this);
	}
	bool IsRifle()
	{
